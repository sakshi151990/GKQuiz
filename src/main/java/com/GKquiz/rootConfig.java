...
@ComponentScan(basePackages = { "com.data", "com.web" }, excludeFilters = {
...
public class rootConfig extends WebMvcConfigurerAdapter {
	...
	public SessionFactory getSessionFactory() {
		 ...
		 * sessionfactory.setPackagesToScan("com.data"); Properties props = new
		 * Properties(); props.setProperty("dialect",
